...
Xtrain_path = "hf://datasets/arss25/tourism_mlops/Xtrain.csv"
Xtest_path = "hf://datasets/arss25/tourism_mlops/Xtest.csv"
ytrain_path = "hf://datasets/arss25/tourism_mlops/ytrain.csv"
ytest_path = "hf://datasets/arss25/tourism_mlops/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "best_toursim_predict_model_v1.joblib"
    ...
    repo_id = "arss25/tourism_mlops_model"
    repo_type = "model"
    ...
    api.upload_file(
        path_or_fileobj="best_toursim_predict_model_v1.joblib",
        path_in_repo="best_toursim_predict_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
